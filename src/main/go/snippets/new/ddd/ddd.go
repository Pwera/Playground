...
import (
	"fmt"
	"github.com/pwera/new/ddd/application"
	"github.com/pwera/new/ddd/controller"
	"github.com/pwera/new/ddd/domain"
	"github.com/pwera/new/ddd/persistence/db"
	"github.com/pwera/new/ddd/persistence/memory"
	"github.com/pwera/new/ddd/protocol/protocol"
...
func ExamppleUserRepository() {
	...
	userClient.SubmitNewUser(context.Background(), nil)
